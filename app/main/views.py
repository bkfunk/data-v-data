from flask import render_template, redirect, url_for, session, g, request, flash, current_app
...
#
#     return remote_app['google'].authorize(callback = url_for(
#         'authorized',
#         _external=True#,
...
#
# @main.route(current_app.config['REDIRECT_URI'])
